      ...
      <ViroAmbientLight color="#ffffff" intensity={200}/>
        <ViroPortalScene passable={true} dragType="FixedDistance" onDrag={()=>{}}>
          <ViroPortal position={[0, 0, -1]} scale={[0.25, 0.25, 0.25]}>
            <Viro3DObject source={require('./res/portal_picture_frame/portal_picture_frame.vrx')}
              resources={[require('./res/portal_picture_frame/portal_picture_frame_diffuse.png'),
          ...
          <Viro360Video source={require("./res/Sea.mp4")}
           loop={true} 
             />
        </ViroPortalScene>
        <ViroImage
